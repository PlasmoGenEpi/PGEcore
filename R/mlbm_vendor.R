# Vendored MultiLociBiallelicModel (SNPModel.R)
# Source: Maths-against-Malaria MultiLociBiallelicModel (Tsoungui Obama & Schneider)
# Kept internal in `.mlbm_vendor` so symbols (e.g. cpoiss, mle) do not clash
# with IDM vendor code or stats::mle.
