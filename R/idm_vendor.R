# Vendored Incomplete Data Model (moi_mle_idm.R)
# Source: Hashemi M, Schneider KA (2024) PLoS ONE 19(3): e0287161
# https://doi.org/10.1371/journal.pone.0287161
# Kept internal in `.idm_vendor` so symbols (e.g. cpoiss) do not clash with
# MultiLociBiallelicModel vendor code.
