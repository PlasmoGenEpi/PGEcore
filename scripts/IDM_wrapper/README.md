...
- Input data is a table of amino acid calls. See 
`../../data/example_amino_acid_calls.tsv` for example.
- Output data are presented in a table of allele frequencies with alleles named
in the STAVE format. Only lineage (allele) frequencies are reported, while other
